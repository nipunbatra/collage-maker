...
python modular_collage_maker.py --folder photos --style all
```

### Advanced Options
```bash
# Custom dimensions
python modular_collage_maker.py --folder photos --style mosaic --width 2560 --height 1440

# Without frames
python modular_collage_maker.py --folder photos --style polaroid --no-frames

# Social media format
python modular_collage_maker.py --folder photos --style grid --width 1080 --height 1080
```
